...
grib_compare ./RSI-KGM2_hybrid_60_rll_290_594_0_006.grib result_solidpr_harmonie.grib
VAR_1=$?
grib_compare ./RRI-KGM2_hybrid_60_rll_290_594_0_006.grib result_rain_harmonie.grib
VAR_2=$?
...
if ../../bin/check-for-gpu.sh; then
  ...
  grib_compare -A 0.01 ./RSI-KGM2_hybrid_60_rll_290_594_0_006.grib result_solidpr_harmonie.grib
  VAR_1=$?
  grib_compare -A 0.01 ./RRI-KGM2_hybrid_60_rll_290_594_0_006.grib result_rain_harmonie.grib
  VAR_2=$?
