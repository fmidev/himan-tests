...
if [ ../../bin/check-for-gpu.sh ]; then
  ...
  grib_compare -b referenceValue -A 0.2 hl_staggered_plugin_result_ff.grib ./FF-MS_hybrid_20_rll_1030_816_0_004.grib
...
rm -f DD-D*.grib FF-MS*.grib U-MS*grib V-MS*grib 
