...
grib_compare -A 0.01 harmonie_gust_result.grib ./FFG-MS_height_10_rll_720_800_0_006.grib
...
if [ ../../bin/check-for-gpu.sh ]; then
  ...
  grib_compare -b referenceValue -A 0.2 harmonie_gust_result.grib ./FFG-MS_height_10_rll_720_800_0_006.grib
...
grib_compare -A 0.1 harmonie_wind_result_FF.grib ./FF-MS_hybrid_15_rll_720_800_0_002.grib
...
grib_compare -A 1 harmonie_wind_result_DD.grib ./DD-D_hybrid_15_rll_720_800_0_002.grib
...
if [ ../../bin/check-for-gpu.sh ]; then
  ...
  grib_compare -b referenceValue -A 0.2 harmonie_wind_result_FF.grib ./FF-MS_hybrid_15_rll_720_800_0_002.grib
