...
grib_compare -A 0.001 hl_result_pres.grib ./T-C_pressure_850_ll_200_200_0_001.grib
...
if [ $(/sbin/lsmod | egrep -c "^nvidia") -gt 0 ]; then
  ...
  grib_compare -b referenceValue -A 0.1 hl_result_pres.grib ./T-C_pressure_850_ll_200_200_0_001.grib
