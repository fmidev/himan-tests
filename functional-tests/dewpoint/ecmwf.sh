...
grib_compare ecmwf_result.grib TD-K_pressure_700_rll_529_461_0_009.grib
...
if [ $(/sbin/lsmod | egrep -c "^nvidia") -gt 0 ]; then
  ...
  grib_compare -A 0.001 ecmwf_result.grib TD-K_pressure_700_rll_529_461_0_009.grib
