...
logger:Info("Current step: " .. tostring(current_time:GetStep()))
...
local t = luatool:Fetch(current_time, lvl, par1, current_forecast_type)
local td = luatool:Fetch(current_time, lvl, par2, current_forecast_type)
